...
function updateProductPrices(sCoCode) {

    var basePrice = parseInt(document.getElementById('loc-price').innerHTML);
    var newPrice;
        if (sCoCode == "GB") {
            newPrice = basePrice * 0.87;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency').innerHTML = "&#163";
            document.getElementById('loc-price').innerHTML = newPrice;
        }
        else if (sCoCode == "CA") {
            newPrice = basePrice * 1.073;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency').innerHTML = "CA&#36; ";
            document.getElementById('loc-price').innerHTML = newPrice;
        }
        else if (sCoCode == "AU") {
            newPrice = basePrice * 1.0731;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency').innerHTML = "AU&#36; ";
            document.getElementById('loc-price').innerHTML = newPrice;
        }
        else if (sCoCode == "IE" || sCoCode == "DE" || sCoCode == "FR") {
            newPrice = basePrice * 0.99;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency').innerHTML = "&#8364;";
            document.getElementById('loc-price').innerHTML = newPrice;
        }

    
    if (document.getElementById('loc-currency-2').innerHTML) {
        var basePrice = parseInt(document.getElementById('loc-price-2').innerHTML);
        var newPrice;
        if (sCoCode == "GB") {
            newPrice = basePrice * 0.87;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency-2').innerHTML = "&#163";
            document.getElementById('loc-price-2').innerHTML = newPrice;
        }
        else if (sCoCode == "CA") {
            newPrice = basePrice * 1.073;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency-2').innerHTML = "CA&#36; ";
            document.getElementById('loc-price-2').innerHTML = newPrice;
        }
        else if (sCoCode == "AU") {
            newPrice = basePrice * 1.0731;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency-2').innerHTML = "AU&#36; ";
            document.getElementById('loc-price-2').innerHTML = newPrice;
        }
        else if (sCoCode == "IE" || sCoCode == "DE" || sCoCode == "FR") {
            newPrice = basePrice * 0.99;
            newPrice = newPrice.toFixed(1) + "0";
            document.getElementById('loc-currency-2').innerHTML = "&#8364;";
            document.getElementById('loc-price-2').innerHTML = newPrice;
        }
    }    
}
